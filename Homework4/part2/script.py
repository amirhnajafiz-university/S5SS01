...
# LSSB - AM
def modulete_low(t):
    return modulate(t) + c(t) * scipy.signal.hilbert(t)
...
y2 = [modulete_low(x) for x in time]
# FT
...
fig, s1 = plt.subplots(5)
s1[0].plot(freq_2, res_2)
s1[1].plot(time, y3)
s1[2].plot(freq_3, res_3)
s1[3].plot(time, y4)
s1[4].plot(freq_4, res_4)
